...
module.exports = {
  ...
  run: async (client, message, args) => {
    let helpEmbed = new MessageEmbed()
      ...
      .addField(
        "About Me:",
        "Hi I am swampplays11, I am a bot developer who codes in node.js! I have been coding since June of 2020. Some of my hobbies are playing video games and coding! ",
      )
      .setThumbnail("https://cdn.discordapp.com/avatars/813890066781962271/1224647ef75999e8308f476e5b1658f5.png?size=1024")
      .setFooter("If you have any questions about the bot, join support server linked below or send me a DM at swampplays11#6613! ")
